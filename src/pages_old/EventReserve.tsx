...
export default function EventReserve() {
  ...
  const canSubmit = selectedDate !== '' && allRequiredFilled && agree && isValidName && isValidPhone && isValidMail;
              ...
              <div className="sticky top-28 flex flex-col gap-8">
                ...
                <div className="bg-surface-container-high p-6 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-3 rounded-full relative bg-primary shadow-[0_0_10px_rgba(45,97,151,0.5)]">
                  ...
                  <div className="flex justify-between mt-3 text-[10px] font-bold text-on-surface-variant uppercase tracking-tighter">
                    <span className="text-primary">날짜 선택</span>
                    <span>예약 정보</span>
                    <span>완료</span>
                  </div>
                </div>
