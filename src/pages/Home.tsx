    ...
    <div className="bg-surface text-on-surface">
      ...
      <footer className="bg-surface-container-highest py-20 px-8 md:px-20 border-t border-outline-variant/20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link to="#" className="text-sm text-on-surface-variant hover:text-primary transition-colors">개인정보처리방침</Link>
              <Link to="#" className="text-sm text-on-surface-variant hover:text-primary transition-colors">이용약관</Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-outline-variant/10 text-center md:text-left">
          <p className="text-xs text-on-surface-variant opacity-70">© 2024 Move-In Fair Management. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
