...
const CATEGORIES = ['all', 'concert', 'exhibition', 'sports', 'performance', 'conference', 'other'];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-10 text-center" style={{ backgroundColor: '#91ADC2' }}>
        <h1 className="text-3xl font-extrabold text-white mb-2">이벤트</h1>
        <p className="text-blue-100 text-sm">원하는 공연, 전시, 콘서트를 찾아보세요</p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="flex gap-2 flex-wrap">
            {CATEGORIES.map(cat => (
              <button
                ...
                style={category === cat ? { backgroundColor: '#91ADC2' } : {}}
              >
        ...
        {filtered.length === 0 ? (
          ...
          <>
            <p className="text-sm text-gray-500 mb-4">총 {filtered.length}개의 이벤트</p>
